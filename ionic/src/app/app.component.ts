...
import { ChatrrrrPage } from "../pages/chatrrrr/chatrrrr";
import { LoginrrPage } from "../pages/loginrr/loginrr";
...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, private renderer: Renderer, private cdr: ChangeDetectorRef,private liveUpdateService:LiveUpdateProvider) {
    ...
    this.pages = [
                  { title: 'Home', component: HomePage } ,{title:'chatrrrr', component: ChatrrrrPage} ,{title:'loginrr', component: LoginrrPage}
                ];
